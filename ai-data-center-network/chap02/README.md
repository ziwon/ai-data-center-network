...
- [Goal](#goal)
- [Frontend vs Backend AI Network](#frontend-vs-backend-ai-network)
- [Training vs. Inference AI Data Centers](#training-vs-inference-ai-data-centers)
  - [Training Data Centers](#training-data-centers)
  - [Inference Data Centers](#inference-data-centers)
  - [Traffic Comparisons and Evolving Data Center Networks](#traffic-comparisons-and-evolving-data-center-networks)
- [InfiniBand vs. Ethernet for AI Training Data Centers](#infiniband-vs-ethernet-for-ai-training-data-centers)
  - [InfiniBand](#infiniband)
  - [Ethernet](#ethernet)
- [Ethernet Hardware Switches and Advanced Software Features](#ethernet-hardware-switches-and-advanced-software-features)
  - [Low Entropy in RoCEv2 Traffic](#low-entropy-in-rocev2-traffic)
  - [Why This Matters](#why-this-matters)
  - [Flowlets](#flowlets)
  - [Hardware and Fabric Design Requirements](#hardware-and-fabric-design-requirements)
  - [Instructor's View](#instructors-view)
- [Handling Elephant Flows](#handling-elephant-flows)
  - [Why Elephant Flows Are Hard](#why-elephant-flows-are-hard)
  - [Burstiness](#burstiness)
  - [Incast Congestion](#incast-congestion)
- [Load-Balancing Techniques](#load-balancing-techniques)
  ...
  - [Selective Dynamic Load Balancing, sDLB](#selective-dynamic-load-balancing-sdlb)
  - [Flow Pinning](#flow-pinning)
  - [Load-Balancing Summary Table](#load-balancing-summary-table)
  - [Conclusion](#conclusion)
- [Congestion Management and Mitigation Techniques](#congestion-management-and-mitigation-techniques)
  - [Proactive Congestion Avoidance](#proactive-congestion-avoidance)
  - [Reactive Congestion Control](#reactive-congestion-control)
  - [ECN](#ecn)
  - [DCQCN](#dcqcn)
  - [PFC](#pfc)
