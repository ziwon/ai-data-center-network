...
this track. Learn the patterns in [PMPP](../../pmpp/README.md) and
[Heterogeneous Systems](../../heterogeneous-systems/README.md), then
...
Related background: [PMPP](../../pmpp/README.md), [Profiling](../profiling/README.md)
...
GPU MODE itself is tracked in [GPU MODE](../../gpu-mode/README.md). This section only pulls out the lectures that are directly useful for kernel case studies.
...
[Heterogeneous Systems (Onur Mutlu)](../../heterogeneous-systems/README.md).
...
- [PMPP](../../pmpp/README.md): background text for basic kernel patterns.
