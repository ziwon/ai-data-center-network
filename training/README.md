...
- Kubernetes에서 실행한다면 [AI Systems Performance Engineering Chapter 3](../systems-performance/chap03/README.md)의 NUMA-local GPU workload case study처럼 CPU pinning, Topology Manager, GPU-local memory path를 함께 확인해야 합니다.
